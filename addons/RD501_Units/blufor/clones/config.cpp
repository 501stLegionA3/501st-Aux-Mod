...
class CfgVehicles
{
	...
	class macro_new_uniform_skin_class(501_avi,Lightning): macro_new_uniform_skin_class(501_inf,recruit)
	{
		author = "RD501";
		scope = 2;
		...
		hiddenSelectionsTextures[] = {"\3as\3as_Characters\clones\uniforms\data\camo\Pilot_Uniform_LOW_POLY_Camo_co.paa","\3as\3as_Characters\clones\uniforms\data\camo1\Pilot_Uniform_LOW_POLY_Camo1_co.paa"};
		hiddenSelectionsMaterials[] = {"\3as\3as_Characters\clones\uniforms\data\camo\Pilot_Uniform_LOW_POLY_Camo_co.paa","\3as\3as_Characters\clones\uniforms\data\camo1\Pilot_Uniform_LOW_POLY_Camo1_co.paa"};
	};
	//
