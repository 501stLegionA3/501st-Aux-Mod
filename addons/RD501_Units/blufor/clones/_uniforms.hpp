...
{
	displayName = "[501st] AVI ARMR 10 (Lightning)";
	model = "3as\3as_Characters\clones\uniforms\Model\3AS_Pilot_Uniform.p3d";
	hiddenSelections[] = {"Camo","Camo1"};
	hiddenSelectionsTextures[] = {"\3as\3as_Characters\clones\uniforms\data\camo\501st\Pilot_Uniform_LOW_POLY_Camo_co.paa","\3as\3as_Characters\clones\uniforms\data\camo1\501st\Pilot_Uniform_LOW_POLY_Camo1_co.paa"};
	class ItemInfo: ItemInfo
	{
